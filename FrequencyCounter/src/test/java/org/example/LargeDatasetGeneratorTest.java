...
public class LargeDatasetGeneratorTest {
    private static final Logger logger = Logger.getLogger(LargeDatasetGeneratorTest.class.getName());
    ...
    public void testLargeInputFileGenerator() {
        ...
        String outputFile = inputFile.toString();

        // Call the method to test
        LargeDatasetGenerator.largeInputFileGenerator();
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = reader.readLine()) != null) {
                assertTrue(line.matches("(-?\\d+\\s*)+"), "Each line should contain integers separated by spaces.");
                lineCount++;
            }
